    ...
    <div className="mt-20 bg-[#F7F8FD] text-[#fff]">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-16">
        ...
        <div className="grid grid-cols-1 gap-20 lg:grid-cols-3">
          <div>
            <p className="mt-1 max-w-md text-center leading-relaxed text-[#71778E] sm:max-w-xs sm:text-left">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
            <div className="text-center sm:text-left">
              <p className="text-2xl text-[#71778E] font-bold text-dark-footerTitle">
                About Us
              </p>
              <ul className="mt-8 space-y-4 text-sm">
                <li>
                  <Link
                    className="text-[#71778E] transition hover:text-[#35afa0]"
                    to="/"
                  >
                    Home
                  </Link>
              ...
              <ul className="mt-8 space-y-4 text-sm">
                <li>
                  <a
                    ...
                    className="flex items-center justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end hover:text-[#35afa0] text-[#71778E]"
                  >
                    <svg
                ...
                <li>
                  <div className="flex items-center justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                    ...
                    <span className="flex-1 text-[#71778E]">
                      +201234567890
                    </span>
                  </div>
                </li>
                ...
                <li className="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                  ...
                  <address className="-mt-0.5 flex-1 not-italic text-[#71778E]">
                    Tanta, Gharbia, Egypt
                  </address>
                </li>
              </ul>
      ...
      >
        <div className="text-center sm:text-left pt-4">
          <div className="text-sm text-slate-300">
            <p className="flex text-md text-[#71778E]">
